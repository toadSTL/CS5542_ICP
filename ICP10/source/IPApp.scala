...
object IPApp {
  ...
  val IMAGE_CATEGORIES = List("court", "flower", "leaf", "meadow", "walkway")//"rice", "tempura", "toast", "bibimap", "sushi", "spaghetti", "sausage", "oden", "omelet", "jiaozi")
  ...
  def generateDecisionTreeModel(sc: SparkContext): Unit = {
    ...
    val decisionTreeModel = DecisionTree.trainClassifier(parsedData, numClasses, categoricalFeaturesInfo,
