...
def read_NewsGroup_data(similarity):    
    categories_3NG = ['comp.graphics', 'rec.sport.baseball', 'talk.politics.guns', 'sci.space', 'talk.politics.guns']
...
stop_learning = 1.10 #--------------------- The stop learning point.
