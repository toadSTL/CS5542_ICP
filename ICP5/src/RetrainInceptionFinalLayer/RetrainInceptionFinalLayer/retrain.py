...
#Change max number of images per class based on our own input
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default= "caltech101/data/train", #'data/flower_photos', #Change the directory here to use our own dataset
